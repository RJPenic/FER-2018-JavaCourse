...
/**
 * Class that demonstrates methods of ArrayIndexedCollection and
 * LinkedListIndexedCollection class.
 *
 */
public class Main1 {

	/**
	 * Main method that allocates collections and demonstrates collection methods.
	 * 
	 * @param args
